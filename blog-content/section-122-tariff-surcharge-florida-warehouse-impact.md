...
date: "2026-03-30"
slug: "section-122-tariff-surcharge-florida-warehouse-impact"
...
For anyone operating, leasing, or investing in [warehouse space across Palm Beach County](/locations/) — from [West Palm Beach](/locations/west-palm-beach/) to [Boca Raton](/locations/boca-raton/) — the next 116 days reshape the math on every decision from [lease negotiation](/blog/warehouse-lease-negotiation-palm-beach-county/) to inventory strategy to [property valuation](/what-is-my-space-worth/).
...
Tax Foundation puts it at roughly $1,000 per household from 2025 tariff increases, another $600 from 2026 measures. For a distributor leasing [industrial space in Lake Worth](/locations/lake-worth/) or a 3PL running [fulfillment operations in Boynton Beach](/locations/boynton-beach/), those costs land before any consumer price adjustment. Real money out the door.

## How the Surcharge Reshapes Warehouse Operations in Palm Beach County

Don't expect the immediate effect on [Palm Beach County's industrial market](/guides/palm-beach-industrial-market/) to show up as higher [lease rates](/blog/warehouse-space-cost-palm-beach-county/). What's actually changing is how tenants use, finance, and occupy space.
...
That squeeze changes how tenants think about [warehouse sizing](/blog/how-much-warehouse-space-do-you-need/). Companies conserving capital downsize or defer expansion. Others — [stockpiling inventory ahead of further increases](/blog/south-florida-industrial-market-outlook-2026/) — need more space on shorter timelines, and they need it with the right [clear height](/blog/warehouse-clear-height-guide/) and [loading dock configuration](/guides/loading-dock-guide/) to maximize throughput on tighter margins.
...
South Florida warehouses hit near-full capacity by April 2025. Then the hangover. Stockpiled inventory depleted, reorder volumes dropped, and [3PL (third-party logistics) operators and flex-space tenants](/guides/warehouse-vs-flex-space/) faced demand cycles that swung month to month.

TRADLINX projected in its 2025 logistics analysis that restocking costs will run roughly 15% higher as inventory purchased at pre-tariff rates gets replaced with goods carrying the full Section 122 burden. For [cold storage operators](/guides/cold-storage/) handling imported produce and for distributors managing [tenant-improved space](/guides/tenant-improvements/) in [Delray Beach](/locations/delray-beach/) or [Lantana](/locations/lantana/), that margin erosion compounds with already-elevated [occupancy costs](/blog/warehouse-space-cost-palm-beach-county/).

### Vacancy, Rent, and the Narrowing Window

Palm Beach County [industrial vacancy](/market-report/) stood at 6.8% in Q4 2025, with a record average asking rent of $16.01 per square foot [NNN (triple net)](/guides/nnn-leases/) — where the tenant pays base rent plus property taxes, insurance, and common area maintenance — per the Colliers Q4 2025 PBC Industrial Report. Net absorption — the total square footage leased minus square footage vacated during a period — totaled 141,890 square feet for the year, and [leasing activity](/guides/how-to-lease-warehouse/) reached 2.9 million square feet.
...
Tenants have a [negotiating window](/blog/warehouse-lease-negotiation-palm-beach-county/) right now, but the supply pipeline is drying up fast. I'm telling every operator I work with the same thing: lock in [tenant improvement allowances](/guides/tenant-improvements/), rent abatement, and [NNN expense caps](/guides/nnn-leases/) while vacancy gives you leverage. That window won't last through 2026.

We track availability across every PBC submarket — from [Jupiter](/locations/jupiter/) to [Boca Raton](/locations/boca-raton/) — with listings updated as inventory turns over. For the full cost breakdown by submarket and lease type, see the [warehouse space pricing analysis](/blog/warehouse-space-cost-palm-beach-county/).

Small-bay [warehouse space](/blog/small-warehouse-space-rent-palm-beach-county/) — under 5,000 square feet — remains the tightest segment, with vacancy barely above 2% countywide per ComReal's South Florida industrial report. If you need a small [warehouse in Jupiter](/locations/jupiter/) near [Park of Commerce](/blog/park-of-commerce-jupiter-tenant-guide/) or a unit in [Royal Palm Beach](/locations/royal-palm-beach/), the tariff environment has not loosened that micro-market. Understanding [commercial zoning requirements](/blog/commercial-zoning-warehouse-palm-beach-county/) before signing matters more when every month of delay costs more in tariffed inventory.

## South Florida's Ports: Cargo Volumes Under Tariff Pressure

Three ports feed [Palm Beach County's warehouses](/locations/). Container throughput is measured in TEUs (twenty-foot equivalent units — the standard measure of container shipping volume). Section 122 introduces uncertainty across all of them.
...
For [warehouse landlords](/guides/landlord-resources/) leasing to import-dependent tenants across PBC's [industrial parks](/blog/industrial-parks-palm-beach-county-comparison/), tenant credit risk just shifted. Understanding whether your tenants can absorb a 10–15% increase in goods costs matters for lease renewal discussions. Landlords considering whether to [list available space](/list-your-space/) or [assess current property value](/what-is-my-space-worth/) should weigh the tariff headwind on tenant demand against the thinning supply pipeline.
...
**What this means for warehouse operators:** If your tenants import goods, their bond capacity directly affects their ability to receive inventory — and pay rent. I've had tenants call because their freight was held at port for two weeks over bond issues. No inventory means no revenue, and they still owe rent. Factor bond status into tenant creditworthiness alongside standard [lease structure review](/guides/nnn-leases/). If you're a [property owner evaluating applications](/guides/landlord-resources/), this is a due diligence item that didn't exist at this scale 18 months ago.

## Five Mitigation Strategies for Florida Warehouse Operators

The surcharge is mandatory. Your response to it is not. Five approaches below — use them alone or stack them — that reduce exposure for operators, tenants, and investors across [Palm Beach County's industrial corridor](/guides/palm-beach-industrial-market/).

### 1. Activate Foreign-Trade Zone Benefits

FTZ #135 operates under the Port of Palm Beach as grantee, covering Palm Beach, Martin, and St. Lucie Counties with eight designated sites, per the Port of Palm Beach's FTZ program page. Key sites include 286 acres at [Palm Beach Park of Commerce](/blog/park-of-commerce-jupiter-tenant-guide/) in [Jupiter](/locations/jupiter/), 25 acres at the Port of Palm Beach in [Riviera Beach](/locations/riviera-beach/), and 24 acres at Palm Beach International Airport near [West Palm Beach](/locations/west-palm-beach/). Most tenants I talk to in PBC don't even know FTZ #135 exists — that's a competitive advantage sitting on the table for anyone importing through the port.
...
Bonded warehouses allow importers to defer tariff payments for up to five years under CBP regulation — paying duties only upon withdrawal for domestic sale, at the rate in effect on the withdrawal date. If Section 122 expires July 24 and you withdraw goods on July 25, the surcharge does not apply. For the full breakdown of bonded warehouse mechanics, CBP application requirements, and cost structures, see the [bonded warehouse tariff deferral guide](/blog/bonded-warehouse-south-florida-tariff-savings/).

### 3. Renegotiate Lease Terms to Offset Tariff-Driven Cost Increases

Tenants absorbing higher duty costs have less margin for occupancy. The current [lease negotiation environment in Palm Beach County](/blog/warehouse-lease-negotiation-palm-beach-county/) favors tenants who act now — vacancy at 6.8% provides leverage that a thinning construction pipeline will erode by late 2026.

Target [free rent periods](/blog/warehouse-lease-negotiation-palm-beach-county/) of 3–4 months on a five-year term, [TI allowances](/guides/tenant-improvements/) of $5–15 per square foot for [warehouse buildout and improvements](/guides/how-to-lease-warehouse/), and [NNN expense caps](/guides/nnn-leases/) limiting annual operating cost escalation. Florida's elimination of the commercial rent sales tax under HB 7031 (effective October 1, 2025) already saves tenants roughly $8,800 per year on a 10,000-square-foot space at $16 per square foot — redirect that savings toward absorbing tariff impact.
...
Florida is the primary gateway for North-South trade, accounting for 29% of all U.S. trade with the Caribbean and Latin America, per the Florida Supply Chain Summit. For [warehouse tenants in Boca Raton](/locations/boca-raton/) and [Lake Worth](/locations/lake-worth/) involved in re-export or LATAM distribution, this corridor offers a structural hedge: goods re-exported through [bonded facilities](/blog/bonded-warehouse-south-florida-tariff-savings/) or FTZ zones incur zero U.S. duties regardless of Section 122.

### 5. Optimize Inventory Timing Around the July 24 Expiration

If Section 122 expires as scheduled, goods entering the country on July 25 would not carry the surcharge. Importers with [sufficient warehouse capacity](/blog/how-much-warehouse-space-do-you-need/) and capital reserves can time large shipments to arrive after expiration. Importers using bonded warehouses have additional flexibility — goods already stored face the duty rate at withdrawal, not at import.

The risk: Congressional action is unpredictable, and the 24-state lawsuit could invalidate the surcharge before its expiration. Building a [flexible warehouse operation](/guides/warehouse-vs-flex-space/) — with overflow capacity on shorter terms rather than rigid long-term commitments — hedges against timing uncertainty. Evaluate spaces with adequate [clear height](/blog/warehouse-clear-height-guide/) and [dock access](/guides/loading-dock-guide/) to handle surge volumes when the inventory timing strategy calls for rapid receipt.
...
No — goods in a [bonded warehouse](/blog/bonded-warehouse-south-florida-tariff-savings/) are assessed duties at the rate in effect when withdrawn for domestic consumption, not when imported. If Section 122 expires on July 24 and goods are withdrawn after that date, the surcharge would not apply, per CBP's Bonded Warehouse Manual.

### How does Section 122 affect warehouse lease rates in Palm Beach County?

Section 122 doesn't directly change [lease rates](/blog/warehouse-space-cost-palm-beach-county/), which hit a record $16.01 per square foot NNN in Q4 2025, per Colliers. The indirect effect is demand-driven: higher duties compress tenant margins, which can push tenants to downsize on [larger spaces](/blog/how-much-warehouse-space-do-you-need/) while driving up demand for bonded and FTZ-designated facilities. [Property owners](/guides/landlord-resources/) should monitor tenant health and bond sufficiency during the surcharge period.

### What is FTZ #135 and how can Palm Beach County businesses use it?

Foreign-Trade Zone #135, operated by the Port of Palm Beach, covers Palm Beach, Martin, and St. Lucie Counties with eight sites. Key locations include [Riviera Beach](/locations/riviera-beach/) (Port of Palm Beach), [Jupiter](/locations/jupiter/) ([Park of Commerce](/blog/park-of-commerce-jupiter-tenant-guide/)), and Palm Beach International Airport near [West Palm Beach](/locations/west-palm-beach/). Businesses within the zone defer duties until goods leave for domestic sale, eliminate duties on re-exports, and can access inverted tariff rates on assembled goods.
...
Three priorities: First, assess tenant exposure — tenants importing goods face higher costs and potential bond insufficiency, so review their financial health. Second, audit [lease structures](/guides/nnn-leases/) for escalation caps and ensure [operating cost provisions](/blog/warehouse-lease-negotiation-palm-beach-county/) are clearly defined. Third, evaluate [listing available space](/list-your-space/) at competitive rates — the construction pipeline remains thin at under 800,000 square feet countywide (Colliers Q4 2025), and demand from bonded and FTZ operators may create premium pricing for [compliant, well-specified buildings](/blog/warehouse-clear-height-guide/).
...
[Browse available warehouse listings](/locations/) across [West Palm Beach](/locations/west-palm-beach/), [Boca Raton](/locations/boca-raton/), [Delray Beach](/locations/delray-beach/), [Jupiter](/locations/jupiter/), [Lake Worth](/locations/lake-worth/), [Boynton Beach](/locations/boynton-beach/), and [Riviera Beach](/locations/riviera-beach/). For bonded-specific options and CBP application requirements, see the [bonded warehouse guide](/blog/bonded-warehouse-south-florida-tariff-savings/). For FTZ activation, contact the Port of Palm Beach's FTZ #135 program office. For help [sizing your space needs](/guides/warehouse-sizing/) or comparing [industrial parks](/blog/industrial-parks-palm-beach-county-comparison/), reach out directly — I work with operators across every submarket in the county.
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "What is the Section 122 tariff surcharge?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Section 122 of the Trade Act of 1974 authorizes the president to impose a temporary import surcharge of up to 15% to address balance-of-payments deficits. It was invoked for the first time in history on February 24, 2026, imposing a 10% ad valorem surcharge on virtually all U.S. imports, per the Federal Register. The surcharge expires July 24, 2026, unless Congress acts."
            }
        },
        {
            "@type": "Question",
            "name": "Does Section 122 apply to goods already in a bonded warehouse?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "No — goods in a bonded warehouse are assessed duties at the rate in effect when withdrawn for domestic consumption, not when imported. If Section 122 expires on July 24 and goods are withdrawn after that date, the surcharge would not apply, per CBP's Bonded Warehouse Manual."
            }
        },
        {
            "@type": "Question",
            "name": "How does Section 122 affect warehouse lease rates in Palm Beach County?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Section 122 does not directly change lease rates, which stood at a record $16.01 per square foot NNN in Q4 2025, per Colliers. The indirect effect is demand-driven: higher duties compress tenant margins, potentially reducing demand for larger spaces while increasing demand for bonded and FTZ-designated facilities. Property owners should monitor tenant health and bond sufficiency during the surcharge period."
            }
        },
        {
            "@type": "Question",
            "name": "What is FTZ #135 and how can Palm Beach County businesses use it?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Foreign-Trade Zone #135, operated by the Port of Palm Beach, covers Palm Beach, Martin, and St. Lucie Counties with eight sites. Key locations include Riviera Beach (Port of Palm Beach), Jupiter (Park of Commerce), and Palm Beach International Airport near West Palm Beach. Businesses within the zone defer duties until goods leave for domestic sale, eliminate duties on re-exports, and can access inverted tariff rates on assembled goods."
            }
        },
        {
            "@type": "Question",
            "name": "Are USMCA goods from Canada and Mexico exempt from Section 122?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "No. While USMCA-compliant goods are exempt from country-specific tariffs, the Section 122 surcharge applies to all imports regardless of origin, per the Tax Foundation. Roughly 85% of Canadian and Mexican imports were claiming USMCA exemptions by January 2026 — those goods now carry a 10% surcharge they did not face before February 24."
            }
        },
        {
            "@type": "Question",
            "name": "What should warehouse landlords do during the surcharge period?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Three priorities: First, assess tenant exposure — tenants importing goods face higher costs and potential bond insufficiency, so review their financial health. Second, audit lease structures for escalation caps and ensure operating cost provisions are clearly defined. Third, evaluate listing available space at competitive rates — the construction pipeline remains thin at under 800,000 square feet countywide (Colliers Q4 2025), and demand from bonded and FTZ operators may create premium pricing for compliant, well-specified buildings."
            }
        },
        {
            "@type": "Question",
            "name": "How do I check my customs bond sufficiency?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Contact your customs broker or surety company to verify your continuous entry bond covers at least 10% of your estimated annual duties, taxes, and fees — including the Section 122 surcharge. In FY2025, CBP flagged a record 27,479 bond insufficiencies valued at $3.6 billion, per CNBC. Insufficient bonds mean CBP holds freight until a new bond is secured — at least 10 days."
            }
        },
        {
            "@type": "Question",
            "name": "Where can I find warehouse space in Palm Beach County to support tariff mitigation?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Browse available warehouse listings across West Palm Beach, Boca Raton, Delray Beach, Jupiter, Lake Worth, Boynton Beach, and Riviera Beach at palmbeachwarehouses.com. For bonded-specific options and CBP application requirements, see the bonded warehouse guide. For FTZ activation, contact the Port of Palm Beach's FTZ #135 program office."
            }
        }
    ]
}
...
<script type="application/ld+json">
{
    ...
    "speakable": {
        ...
        "cssSelector": [".guide-content h1", ".guide-content > p:first-of-type", ".guide-content > p:nth-of-type(2)"]
    },
    "url": "https://palmbeachwarehouses.com/blog/section-122-tariff-surcharge-florida-warehouse-impact/"
}
</script>

<!--
SPEAKABLE: The Section 122 tariff surcharge, invoked for the first time in history on February 24, 2026, imposes a 10% ad valorem duty on virtually all U.S. imports and expires July 24, 2026. For Palm Beach County warehouse operators and tenants, the surcharge compresses cash flow, strains customs bonds, and reshapes demand for bonded and foreign-trade-zone-designated industrial space.

KEY_TAKEAWAY: Section 122's 10% surcharge stacks on top of existing tariffs — pushing effective rates above 50% on steel, aluminum, and Chinese goods — and the bond sufficiency crisis (27,479 insufficiencies worth $3.6 billion in FY2025 per CNBC) is the sleeper risk that can freeze freight at port for 10+ days.

ANSWERS_QUERIES:
- What is the Section 122 tariff surcharge and how does it affect warehouse tenants in Florida?
- How much do tariffs cost importers using warehouses in Palm Beach County?
- What is FTZ 135 and how can Palm Beach County businesses use it to reduce tariffs?
- How do customs bond insufficiencies affect warehouse operations in South Florida?
- What mitigation strategies exist for warehouse operators during the Section 122 surcharge?
